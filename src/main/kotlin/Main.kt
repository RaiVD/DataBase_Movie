...
fun main() {
    ...
    val favoriteMoviesService = TableFavoriteMovieService()
...
//        "Ação"
//    )
//    favoriteMoviesService.addFavoriteMovie("Doutor Estranho no Multiverso da Loucura", "hq2igFqb31fDqGotz8ZuUfwKgn8.jpg")
//    favoriteMoviesService.addFavoriteMovie("Homem-Aranha: Sem Volta para Casa", "KEY ART_SPIDER NO WAY HOME.JPG")
